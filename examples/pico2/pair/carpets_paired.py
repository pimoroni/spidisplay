...
Both tiles are tiny, a pattern being only the smallest piece that repeats, so the two
together are a fraction of one panel-sized image. Neither is drawn after startup: the
drift is the offset, and it costs nothing.
